...
jQuery(document).on('click', '.option2', function (el) {
    ...
    let optionIndex = jQuery(el.currentTarget).index() + 1;
    let fullOptionIndex = jQuery(el.currentTarget).parent().parent().index() + 2;
    ...
    var tl = anime.timeline({
        ...
        complete: function () {
            //reset menu
            closeMenuAfterSelection(parentClickTarget, clickTarget);
        }
    });
